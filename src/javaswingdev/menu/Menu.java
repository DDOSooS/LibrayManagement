...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        addTitle("Emprunt");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MAIL_OUTLINE, "Emprunt", "nouveau emprunt", "consultation des comptes", "enregistremet de retour"));
        addTitle("Etudiant");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MESSAGE, "Etudaint", "historique emprunt", "statistique du materiel", "materiel","Delai","pret Sensible"));
       addTitle("materiel");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERM_CONTACT_CALENDAR, "Materiel", "ajout materiel", "modification materiel", "suprimer un materile"));
 
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ERROR_OUTLINE, "LOG OUT", "404", "500"));
    }
